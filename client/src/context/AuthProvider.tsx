...
const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [right, setRight] = useState(JSON.parse(localStorage.getItem('right')))
  const [footer, setFooter] = useState(
    JSON.parse(localStorage.getItem('footer')),
  )
  const [panel, setPanel] = useState(JSON.parse(localStorage.getItem('panel')))
  const [all, setAll] = useState(JSON.parse(localStorage.getItem('all')))

  // 🧰 Action bar toggles
  const [preview, setPreview] = useState(
    JSON.parse(localStorage.getItem('preview')),
  )
  const [split, setSplit] = useState(JSON.parse(localStorage.getItem('split')))
...
`)
  ...
  useEffect(() => {
    setTag(JSON.parse(localStorage.getItem('tag')))
    setBottom(JSON.parse(localStorage.getItem('bottom')))
    setHeader(JSON.parse(localStorage.getItem('header')))
    setRight(JSON.parse(localStorage.getItem('right')))
    setFooter(JSON.parse(localStorage.getItem('footer')))
    setPanel(JSON.parse(localStorage.getItem('panel')))
    setAll(JSON.parse(localStorage.getItem('all')))
    setPreview(JSON.parse(localStorage.getItem('preview')))
    setSplit(JSON.parse(localStorage.getItem('split')))
    setMobile(JSON.parse(localStorage.getItem('mobile')))
    setTemplate(JSON.parse(localStorage.getItem('template')))
  }, [])
