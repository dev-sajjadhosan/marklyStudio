...
const Footer = ({ ui = true }: { ui?: boolean }) => {
  return (
    <>
      {ui ? (
        ...
        <footer className="flex flex-col md:flex-row justify-between items-center gap-3 p-7 text-base-content border-base-300 border-t w-full">
